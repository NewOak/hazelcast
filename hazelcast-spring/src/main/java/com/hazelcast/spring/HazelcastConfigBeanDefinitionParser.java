...
*/
        ...
        public void handleJoin(Node node, BeanDefinitionBuilder networkConfigBuilder) {
            ...
            for (org.w3c.dom.Node child : new IterableNodeList(node, Node.ELEMENT_NODE)) {
                ...
                if ("multicast".equals(name)) {
                    ...
                    handleAzure(child, joinConfigBuilder);
                }
        ...
        private void handleAzure(Node node, BeanDefinitionBuilder joinConfigBuilder) {
            createAndFillBeanBuilder(node, AzureConfig.class, "azureConfig", joinConfigBuilder);
        }
